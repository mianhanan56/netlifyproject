  ...
  return (
    ...
    <div className='assets-tracking'>
        ...
        <div className="section">
            <div className="row">
                <div className="col-12">
                    <div className='asset-tracking-header'>
                    <h1 className='heading'>
                    Asset <span className='color-header'>tracking</span> & <span className='color-header'>monitoring</span>
                    </h1>
                    <p className='body'>
                    With Edge Impulse, intelligent asset tracking is unlocking new insights in supply chain, logistics, agriculture <br/> and other industries where sensor, audio and vision data can be used to provide more <br/>contextual awareness to assets.
                    </p>
                    <div className="btn">
      ...
      <Card>
        ...
        <CardGroup>
      <Card>
        <Card.Body className='support-body'>
