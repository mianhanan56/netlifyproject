            ...
            <div className="row">
              <div className="col-md-12">
                <div className="appliance-heading">
                  <h1>
                    <span className="color-header">Intelligent</span> appliances
                  </h1>
                  <p>
        ...
        <div className="case-study-section">
          <div className="container">
            ...
            <div className="case-study-card">
              <div className="row">
                <div className="col-md-6">
                  <div className="case-left-section">
                    <h4>IoT Gets an ML Boost, From Edge to Cloud</h4>
                    <p>
                      Today, it’s easy to run Edge Impulse machine learning on
                      any OS like the Linux-powered Raspberry Pi and on every
                      cloud, including Microsoft’s Azure IoT.
                    </p>
                    <span>
                      <a href="#">
